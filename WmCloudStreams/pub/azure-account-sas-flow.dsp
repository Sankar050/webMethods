<html>
	<head>
		<title>Azure Account SAS Flow</title>
		...
		<SCRIPT SRC="js/azure-account-sas-flow.js" type="text/javascript"></SCRIPT>
	...
	<body style="border-spacing: 0; border-width:0">
		<form action="#">
			...
			<input type="hidden" name="flow" class="flow" value="cloudstreams.azure:accountSASFlow">
			<table id="EndPointTable" class="tableView" width="100%" />
			<table id="mainTable" class="tableView" width="100%" />
				<!-- all rows dynamically updated -->
				<table class='tableView' summary="Table to input Specifying Account SAS Parameters information">
					<tbody>
					<tr>
						<!--td class="heading" colspan=2>Specify Account SAS Parameters</td-->
					</tr>
					</tbody>
				</table>
