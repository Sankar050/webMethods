...
function HideFewFields(){
	...
	// Toggle the link
	var x = document.getElementById('basicAdvancedTD');
	x.innerHTML = getmsg('connection.view.basic')+" | <a href='javascript:void(0)' onclick='javascript:ShowAllFields(); showHeading()'>" +
...
function ShowAllFields(){
	...
	// Toggle the link
	var x = document.getElementById('basicAdvancedTD');
	x.innerHTML = "<a href='javascript:void(0)' onclick='javascript:HideFewFields(); hideHeading()'> "+ getmsg('connection.view.basic')+"</a> | " + getmsg('connection.view.advanced');
}
