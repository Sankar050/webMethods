  ...
  <TABLE width="100%">
    ...
    <TR>
	  ...
	  <table class="tableView" width="85%">
		  ...
		  <TR>
            <TD width="40%" class="oddrow-l"><label for="autoDeleteRequestReply">Auto Delete Request-Reply Channel (on disconnect)</label></TD>
            <TD class="oddrowdata-l">
              %ifvar autoDeleteRequestReply equals(true)%
                <INPUT TYPE="checkbox" id="autoDeleteRequestReply" NAME="autoDeleteRequestReply" checked="true" />
              %else%
                <INPUT TYPE="checkbox" id="autoDeleteRequestReply" NAME="autoDeleteRequestReply" />
              %endif%
            </TD>
          </TR>
