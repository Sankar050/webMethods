...
<TR>
    ...
    <TD class="evenrow-l">
		<INPUT TYPE="password" NAME="messagePassword" id="messagePassword" autocomplete="new-password" VALUE="%value password encode(htmlattr)%" style="width:40%" />
    </TD>
</TR>
...
<TR>
    ...
    <TD class="oddrow-l">
		<INPUT TYPE="password" NAME="retype_messagePassword" id="retype_messagePassword" autocomplete="new-password" VALUE="%value password encode(htmlattr)%" style="width:40%" />
    </TD>
</TR>
%endif%
</tbody>
...
%else%
    <TR id="clntPwdRow">
        ...
        <TD class="evenrowdata-l">
			<input type="password" name="krbClientPassword" id="krbClientPassword" value="%value kerberosSettings/clientPassword encode(htmlattr)%" autocomplete="new-password" style="width:40%">
        </TD>
    </TR>
    <TR id="clntPwdReRow">
        <TD class="oddrow"><label for="retype_krbClientPassword">Retype Principal Password</label></TD>
        <TD class="oddrowdata-l">
			<input type="password" name="retype_krbClientPassword" id="retype_krbClientPassword" value="%value kerberosSettings/clientPassword encode(htmlattr)%" autocomplete="new-password" style="width:40%">
        </TD>
    </TR>
%endif%
</tbody>
