  ...
  <TABLE width="100%">
    ...
    <tr>
	  ...
	  <table class="tableView" width="85%">	  
		  ...
		  <TR>
            <TD width="40%" class="oddrow-l">Auto Delete Request-Reply Channel (on disconnect)</TD>
            <TD class="oddrowdata-l">%ifvar autoDeleteRequestReply equals('true')% Yes %else% %ifvar autoDeleteRequestReply equals('on')% Yes %else% No %endif% %endif% </TD>
          </TR>
