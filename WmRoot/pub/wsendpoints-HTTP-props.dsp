...
<TR>
  ...
  <TD class="oddrow-l">
		<INPUT TYPE="password" id="transportPassword" NAME="transportPassword" autocomplete="new-password" VALUE="%value password encode(htmlattr)%" style="width:40%" />
  </TD>
</TR>
<TR>
  <TD class="evenrow"><label for="retype_transportPassword">Retype Password</label></TD>
  <TD class="evenrow-l">
			<INPUT TYPE="password" NAME="retype_transportPassword" id="retype_transportPassword" autocomplete="new-password" VALUE="%value password encode(htmlattr)%" style="width:40%" />
  </TD>
</TR>
%endif%
<TR>
...
%else%
    <TR id="clntPwdRow">
        ...
        <TD class="evenrowdata-l">
			<input type="password" name="krbClientPasswordTransport" id="krbClientPasswordTransport" value="%value kerberosSettingsTransport/clientPassword encode(htmlattr)%" autocomplete="new-password" style="width:40%">
        </TD>
    </TR>
    <TR id="clntPwdReRow">
        <TD class="oddrow"><label for="retype_krbClientPasswordTransport">Retype Principal Password</label></TD>
        <TD class="oddrowdata-l">
			<input type="password" name="retype_krbClientPasswordTransport" id="retype_krbClientPasswordTransport" value="%value kerberosSettingsTransport/clientPassword encode(htmlattr)%" autocomplete="new-password" style="width:40%">
        </TD>
    </TR>
%endif%
</tbody>
